...
read = Filefifo(10, name='capture01_250Hz.txt')
data = []
cursor = 0
scale = 1
mScale = [0.1, 25000]
...
while True:
    ...
    if rot.fifo.has_data():
        ...
        while rot.fifo.has_data() and button0.value() == 0 and button1.value() == 1 and button2.value() == 1 and len(
                data) > 0:
            ...
            if offset > mOffset[1]:
                offset = mOffset[1]
        while rot.fifo.has_data() and button0.value() == 1 and button1.value() == 1 and button2.value() == 0 and len(
                data) > 0:
